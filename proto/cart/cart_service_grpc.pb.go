...
const (
	...
	CartService_GetItemsCount_FullMethodName = "/cart.CartService/GetItemsCount"
)
...
type CartServiceClient interface {
	...
	GetItemsCount(ctx context.Context, in *GetItemsCountRequest, opts ...grpc.CallOption) (*ItemsCountResponse, error)
}
...
func (c *cartServiceClient) GetItemsCount(ctx context.Context, in *GetItemsCountRequest, opts ...grpc.CallOption) (*ItemsCountResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ItemsCountResponse)
	err := c.cc.Invoke(ctx, CartService_GetItemsCount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CartServiceServer interface {
	...
	GetItemsCount(context.Context, *GetItemsCountRequest) (*ItemsCountResponse, error)
...
func (UnimplementedCartServiceServer) GetItemsCount(context.Context, *GetItemsCountRequest) (*ItemsCountResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetItemsCount not implemented")
}
...
func _CartService_GetItemsCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetItemsCountRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CartServiceServer).GetItemsCount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CartService_GetItemsCount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CartServiceServer).GetItemsCount(ctx, req.(*GetItemsCountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CartService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetItemsCount",
			Handler:    _CartService_GetItemsCount_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "cart/cart_service.proto",
}
