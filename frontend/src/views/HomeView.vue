        ...
        <div class="row align-items-center py-5">
          <div class="col-lg-6">
            <h1 class="display-4 fw-bold mb-4">
              Добро пожаловать в Kinos!
            </h1>
            <p class="lead mb-4">
              Ваш любимый интернет-магазин электроники и товаров для дома
            </p>
          ...
          <div class="col-md-4">
            <div class="card h-100 border-0 shadow-sm">
              <div class="card-body text-center">
                ...
                <p class="text-muted">
                  Доставим ваш заказ в кратчайшие сроки по всей стране
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="card h-100 border-0 shadow-sm">
              <div class="card-body text-center">
                ...
                <p class="text-muted">
                  Различные способы оплаты: карта, наличные, рассрочка
                </p>
              </div>
            </div>
          </div>
